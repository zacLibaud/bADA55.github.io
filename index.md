...
<head>
    ...
    <title>Toggle Visuals</title>
</head>
<body>
    <h1>Choose a Visualization</h1>
    <select id="dropdown" onchange="updateVisualization()">
        <option value="figs/ba_pca_clusters.html">BeerAdvocate PCA Clusters</option>
        <option value="figs/rb_pca_clusters.html">RateBeer PCA Clusters</option>
    </select>
    
    <div id="visualization" style="margin-top: 20px;">
        <iframe id="iframe" src="ba_pca_clusters.html" style="width: 100%; height: 500px; border: none;"></iframe>
    </div>
